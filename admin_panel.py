...
ADMIN_TEXT = {
    "uz": {
        ...
        "wallet_link": "Telegram Wallet link",
    ...
    "ru": {
        ...
        "payment_settings_hint": "Настройки оплаты и Airalo сохраняются в .env. Бот прочитает их при следующих запросах.",
        "card_holder": "Владелец карты",
        "card_number": "Номер карты",
        "qr_image_file": "Файл QR изображения",
        "qr_link": "QR ссылка",
        "payment_note": "Примечание к оплате",
        "wallet_link": "Telegram Wallet ссылка",
        "wallet_address": "Wallet address",
        "card_payment_link": "Visa/Mastercard payment link",
    ...
    "en": {
        ...
        "payment_settings_hint": "Payment and Airalo settings are saved to .env. The bot reads them on the next requests.",
...
def settings_page(message: str = "", error: str = ""):
    ...
    env_fields = [
        ...
        ("TELEGRAM_WALLET_PAY_LINK", admin_t("wallet_link")),
        ("TELEGRAM_WALLET_ADDRESS", admin_t("wallet_address")),
...
def update_bot_settings(params: dict) -> None:
    keys = [
        ...
        "CARD_QR_LINK",
        "CARD_PAYMENT_NOTE",
        "TELEGRAM_WALLET_PAY_LINK",
        "TELEGRAM_WALLET_ADDRESS",
        "CARD_PAYMENT_LINK",
        "PAYME_PAYMENT_LINK",
        "CLICK_PAYMENT_LINK",
        "AIRALO_CLIENT_ID",
